...
[
	...
	dnl 
	dnl
        GLITE_DGAS_COMMON_DBHELPER_LIBS=" -lglite_dgas_dbhelper"
	GLITE_DGAS_COMMON_CONFIG_LIBS=" -lglite_dgas_config"
	GLITE_DGAS_COMMON_DIGESTS_LIBS=" -lglite_dgas_digests"
	GLITE_DGAS_COMMON_LOG_LIBS=" -lglite_dgas_log"
	GLITE_DGAS_COMMON_GRIDMAPFILE_LIBS=" -lglite_dgas_gridMapFile"
	GLITE_DGAS_COMMON_LOCK_LIBS=" -lglite_dgas_lock"
	GLITE_DGAS_COMMON_XMLUTIL_LIBS=" -lglite_dgas_xmlutil"
	GLITE_DGAS_COMMON_LDAP_LIBS=" -lglite_dgas_ldap"
	ifelse([$2], , :, [$2])
    else
